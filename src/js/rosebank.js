...
$('<li id="extra_menu_item" class="menu-item"><a href="/courses/187" class="menu-item-no-drop">Learning Resources</a></li>').hide().appendTo("ul#menu").fadeIn(300);

// Change any reference to 'Marks' to 'Results & Feedback'
var marksFor = $('div#content[role="main"] h2').first().text().split(' ');
